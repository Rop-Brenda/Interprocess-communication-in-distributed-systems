 ...
 * @author Brenda Rop
 */
public class Server_Socket extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        msg_send.setBackground(new java.awt.Color(255, 102, 0));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Server_Socket().setVisible(true);
            }
        });
        ...
        String msgin = "";
        try{
          ss = new ServerSocket(51318); //server starts  at 51318  port number
          s = ss.accept();  //accept incoming requests to server ss from client
